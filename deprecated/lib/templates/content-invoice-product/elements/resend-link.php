...
<div class="it-exchange-invoice-section it-exchange-invoice-resend it-exchange-clearfix">
	...
	<p>
		<?php printf( __( 'This invoice may only be accessed using the link in your email. %sResend email%s', 'LION' ), '<a rel="nofolow" href="' . esc_url( add_query_arg( 'it-exchange-invoice-resend', '1' ) ) . '">', '</a>' ); ?>
	</p>
